...
public class EditSubjectDialog extends javax.swing.JDialog implements ActionListener{
    ...
    public EditSubjectDialog(java.awt.Frame parent, boolean modal,Subject s) {
        this(parent, modal);
        this.s = s;
        loadSubject();
    ...
    private void EditSubject() {
        ...
        if(lesson.isEmpty() || subjectName.isEmpty()){
            ...
            showMessage("Sửa học thành công");
            homeFRM.CallBackEditSubjects(s);
            dispose();
        }
    }
    ...
    private void loadSubject() {
        ...
        txtLesson.setText(s.getTotalLesson()+"");
        txtSubjectName.setText(s.getSubjectName());
        comboSubject.setSelectedItem(s.getSubjectType());
